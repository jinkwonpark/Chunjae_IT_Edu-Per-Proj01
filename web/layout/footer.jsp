    ...
    <ul class="snb">
      ...
      <li class="locate">
        <select name="sel" id="sel" onchange="loc()">
          ...
          <option value="https://chunjaetext.co.kr/">웨일교과서</option>
          <option value="http://www.milkt.co.kr/Main/Main_new">웨일T</option>
...
<div class="ft_wrap2">
  ...
  <p class="copyright">
    <span>웨일에듀 1577-0902</span>
    <span>리틀웨일 1577-0218</span>
    <span>월간우등생학습 1577-6226</span>
    <span>웨일T초등 1577-1533</span>
    <span>웨일T중학 1522-5533</span>
    <span class="end">웨일T고등 1522-5533</span>
  </p>
  <p class="cp">COPYRIGHT 1981-2023 WHALE EDUCATION INC. ALL RIGHTS RESERVED.</p>
</div>