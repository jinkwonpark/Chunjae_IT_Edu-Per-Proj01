...
<<%
    ...
    sql = "SELECT cno, author, resdate, content FROM boardComment WHERE bno=? ORDER BY cno DESC LIMIT 0, 10";
    pstmt = con.prepareStatement(sql);
    pstmt.setInt(1, bno);
    rs = pstmt.executeQuery();
                ...
                <table class="comment_detail">
                    ...
                    <tr>
                        <td class="add_comment">
                            <textarea name="content" id="contents" class="input_comment" placeholder="댓글을 입력해주세요" required></textarea>
